...
function SettingsItem({ icon, label, onPress, rightElement, destructive, colors }: SettingsItemProps) {
  return (
    <TouchableOpacity
      onPress={onPress}
    ...
    >
      ...
      <Text style={[styles.settingsLabel, { color: destructive ? colors.danger : colors.textPrimary }]}>
        {label}
      </Text>
      <View style={styles.settingsRight}>
        {rightElement ?? <Feather name="chevron-right" size={16} color={colors.border} />}
      </View>
    </TouchableOpacity>
  );
}
  ...
  return (
    ...
    >
      <View style={[styles.profileHeader, { borderBottomColor: colors.border }]}>
        <View style={[styles.bigAvatar, { backgroundColor: colors.primary, borderColor: colors.primary }]}>
      ...
      <SettingsSection title="MINHA CONTA" colors={colors}>
        ...
        <SettingsItem
          ...
          label="Tema do app"
          onPress={() => {}}
          rightElement={<Text style={[styles.rightLabel, { color: colors.textSecondary }]}>Sistema</Text>}
          colors={colors}
        />
        <SettingsItem
          icon="globe"
          label="Idioma"
          onPress={() => {}}
          rightElement={<Text style={[styles.rightLabel, { color: colors.textSecondary }]}>Português</Text>}
          colors={colors}
        />
      </SettingsSection>

      <SettingsSection title="MEUS DADOS" colors={colors}>
      ...
      <SettingsSection title="SUPORTE" colors={colors}>
        ...
        <SettingsItem
          ...
          label="Versão do app"
          colors={colors}
          rightElement={<Text style={[styles.rightLabel, { color: colors.textSecondary }]}>v1.0.0</Text>}
        />
      </SettingsSection>

      <TouchableOpacity onPress={handleLogout} style={[styles.logoutBtn, { borderColor: colors.border }]} activeOpacity={0.75}>
